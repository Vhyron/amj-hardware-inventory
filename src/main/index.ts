...
import { setupCategoriesIPC } from './lib/service/categories/categories-ipc'
import { setupSuppliersIPC } from './lib/service/suppliers/suppliers-ipc'
import { setupSupplyOrdersIPC } from './lib/service/supplyOrders/supplyOrders-ipc'
...
app.whenReady().then(() => {
  ...
  setupCategoriesIPC()
  setupSuppliersIPC()
  setupSupplyOrdersIPC()
  setupTransactionsIPC()
  setupActivityLogsIPC()
